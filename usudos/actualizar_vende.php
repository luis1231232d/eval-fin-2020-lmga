<?php
    ...
    $id = $_GET["id"];
	$usuarios = "select * from usuarios where id_tipo_usu = 2 and documento = '$id'";
?>
...
<header id="header">
    <div class="salir">
       <a href="edicionvende.php"><img height="30px" widih="50px"src= "../img/salir.jpg.png" alt=""></a> 
    </div>
</nav>
</header> 
<body>
	<form class="container-table container-table--edit" action="proce_vende.php" method="POST">
