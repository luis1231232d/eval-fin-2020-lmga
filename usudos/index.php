...
<body>   
    <header id="header">
        <nav class="menu">
            ...
            <a class="nombre">BIENVENIDO VENDEDOR</a>
            <div class="salir">
    ...
    <div class="foto">
        ...
        <h3 class= "admin">Carlos Andres</h3>
        <h3 class= "admin1">Quintero Cardona</h3>
    </div>
    <div class="menu2"> 
        <ul class="nav">
            <li><a href="#">INFORMACION PESONAL</a>
                <ul>
                    <li><a href="edicionvende.php">Editar pefil</a></li>
                </ul>
            </li>
            <br>
            <li><a href="#">DATOS CLIENTES</a>
                <ul>
                    <li><a href="mostrar.php">VER DATOS CLIENTES</a></li>
                </ul>
            </li>
            <br>
            <li><a href="#">VENTAS</a>
