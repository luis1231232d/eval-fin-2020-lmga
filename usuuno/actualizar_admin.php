<?php
    ...
    $id = $_GET["id"];
	$usuarios = "select * from usuarios where id_tipo_usu = 1 and documento = '$id'";
?>
...
<header id="header">
    <div class="salir">
       <a href="edicionadmin.php"><img height="30px" widih="50px"src= "../img/salir.jpg.png" alt=""></a> 
    </div>
</nav>
</header> 
<body>
	<form class="container-table container-table--edit" action="proce_admin.php" method="POST">
