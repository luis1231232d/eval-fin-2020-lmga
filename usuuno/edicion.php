	...
	<div class="container-table container-table--edit">
        ...
        while ($row= mysqli_fetch_assoc($resultado)) { ?>
            ...
            <div class="table__item">
                <a href="actualizar.php?id=<?php echo $row["documento"];?>"class="table__item__link">Modificar</a> ||

                <a href="proce_eliminar.php?id=<?php echo $row["documento"];?>" class="table__item__link">Eliminar</a>
            </div>
